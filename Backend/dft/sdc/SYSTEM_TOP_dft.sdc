...
# Created by write_sdc on Tue Aug 23 04:05:35 2022
...
create_clock [get_ports scan_clk]  -name CLK3  -period 100  -waveform {0 50}
set_clock_uncertainty -setup 0.2  [get_clocks CLK3]
set_clock_uncertainty -hold 0.1  [get_clocks CLK3]
set_input_delay -clock CLK_UART  217.014  [get_ports RX_IN]
set_output_delay -clock TX_CLK  217.014  [get_ports TX_OUT]
set_clock_groups -asynchronous -name Functional Clocks -group [list [get_clocks CLK_UART] [get_clocks TX_CLK]] -group [list [get_clocks CLK_REF] [get_clocks ALU_CLK]] -group [get_clocks CLK3]
