...
set CLK3_NAME CLK3
set CLK3_PER 100
set CLK3_SETUP_SKEW 0.2
set CLK3_HOLD_SKEW 0.1
set CLK3_LAT 0
set CLK3_RISE 0.05
set CLK3_FALL 0.05

create_clock -name $CLK3_NAME -period $CLK3_PER -waveform "0 [expr $CLK3_PER/2]" [get_ports scan_clk]
set_clock_uncertainty -setup $CLK3_SETUP_SKEW [get_clocks $CLK3_NAME]
set_clock_uncertainty -hold $CLK3_HOLD_SKEW  [get_clocks $CLK3_NAME]


set_dont_touch_network {REF_CLK UART_CLK RST scan_clk}
####################################################################################
           #########################################################
...
set_clock_groups -asynchronous \
                 -group [get_clocks "$UART_CLK_NAME TX_CLK"] \
...
#et_wire_load_model -name tsmc13_wl30 -library scmetro_tsmc_cl013g_rvt_ss_1p08v_125c
